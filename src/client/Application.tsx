    ...
    return <div className={bem()}>
        ...
        <nav className="navbar navbar-expand-sm navbar-light bg-light">
            <div className="container">
                ...
                <button data-testid="btn" className={bem('Toggler', ['navbar-toggler'])} aria-label="Toggle navigation" onClick={toggle}>
                    <span className="navbar-toggler-icon"></span>
                </button>
                <div className={bem('Menu', [navbarClass])}>
                    <div className="navbar-nav">
                        <NavLink data-testid="catalog" className="nav-link" activeClassName="active" to="/catalog" onClick={hide}>Catalog</NavLink>
